# DF-DashboardWIN
This is only for the DF-Crew.
If you download it and you are not DF-Crewmember this programm is then useless.
## Packages
```bash
pip install pywebview pyinstaller
```
### Then download DF-Dashboard.py and DFCO.ico
### Create an folder named DF-Dashboard
